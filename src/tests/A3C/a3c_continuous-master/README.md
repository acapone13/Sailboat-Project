...
```
python3 main.py --env voilier-v0 --workers 6 --gpu-ids 0 --amsgrad True --model MLP --stack-frames 4
```
```
python gym_eval.py --env voilier-v0 --num-episodes 100 --stack-frames 4 --model MLP --new-gym-eval True
```